...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vbw_label = QtWidgets.QLabel(self.analyserTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.vbw_label.sizePolicy().hasHeightForWidth())
        self.vbw_label.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(7)
        font.setBold(True)
        font.setWeight(75)
        self.vbw_label.setFont(font)
        self.vbw_label.setObjectName("vbw_label")
        self.gridLayout_3.addWidget(self.vbw_label, 6, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.vbw_label.setText(_translate("MainWindow", "VBW"))
